...
{
    public class MyHeldPose : IHeldPose
    {
        #region Constants
        ...
        #region Constructors
        public MyHeldPose(IMyoEventGenerator myo, TimeSpan interval, IEnumerable<Pose> targetPoses)
        {
            ...
            {
                Interval = TimeSpan.FromMilliseconds(interval.TotalMilliseconds),
            };
        ...
        public TimeSpan Interval
        {
            get
            {
                var interval = TimeSpan.FromMilliseconds(_timer.Interval.Milliseconds);
            ...
            set
            {
                _timer.Interval = TimeSpan.FromMilliseconds(value.TotalMilliseconds);
            }
        }
        #endregion
